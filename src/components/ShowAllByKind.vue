        ...
        methods:{
            loadByKind(id){
                let _this =this;
                    ...
                    this.$axios.get('/blog/listByKind?id='+id+'&pageSize='+_this.pageSize+'&pageNum='+_this.pageNum).then(resp => {
            ...
            handleCurrentChange(page) {
                this.pageNum=page;
                let _this = this;
                this.$axios.get('/blog/listByKind?id='+_this.kind+'&pageSize='+_this.pageSize+'&pageNum='+_this.pageNum).then(resp => {
                    if (resp && resp.data.code === 200) {
                        // _this.books = resp.data.result
                        // console.log(resp.data.result);
                        // console.log(resp);

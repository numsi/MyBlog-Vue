        ...
        <el-card style="text-align: left;width: 990px;margin: 35px auto 0 auto">
            <div>
                ...
                <div style="text-align: center">
                    <span style="font-size: 20px"><strong><h2>{{blog.blog_title}}</h2></strong></span>
                </div>
                <!--作者-->
                <div style="text-align: center">
                    <h4>作者：<router-link to="">{{blog.blog_author}}</router-link></h4>
                </div>
                <el-divider content-position="left">
                    ...
                    <span style="margin-left: 40px">
                        最后更新于{{blog.blog_creattime}}
                    </span>
                </el-divider>
                <!--博文内容-->
                <div class="markdown-body">
                    <div v-html="blog.blog_content_html"></div>
                </div>
                <!--点赞功能-->
                <div>
        ...
        data(){
            return{
                blog:{
                    blog_id:'1',
                    blog_title:'凉风有兴1',
                    blog_creattime:'2020-01-13 21:14:27',
                    blog_updatetime:'2020-01-13 21:14:27',
                    blog_author:'test',
                    blog_content_html:'<p><img src="https://i.loli.net/2019/12/15/sYnuTIrDUwAfGgo.png" alt="wjlogo.png" /></p>\n' +
                    '<hr />\n' +
                    ...
                    '04-04 完成图书删除功能<br />\n' +
                    '04-03 完成图书新增功能</p>\n',
                    blog_content_md:'![wjlogo.png](https://i.loli.net/2019/12/15/sYnuTIrDUwAfGgo.png)\n' +
                    '\n' +
                    '---\n' +
                    '\n' +
                    ...
                    '04-03 完成图书新增功能\n',
                    blog_views:'0',
                    blog_abstract:'凉风有兴，秋月无边，而我思乡的情绪好比度日如年。',
                    blog_cover:'https://i.loli.net/2020/01/16/d2ZlKI1WRE4p7XB.png',
                },
                isLike:false
            }
        },
